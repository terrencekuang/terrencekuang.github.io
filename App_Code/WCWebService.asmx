...
/*		[WebMethod(Description = "This web method facilitates web service to send request XML to QuickBooks via QBWebConnector", EnableSession = true)]
		...
		/// - "" = No more request XML 
		/// </summary>
		public string employeeQuerry(string fullName)
		{
			fullName = "ALAN NG";
			...
			EmployeeQueryRq.SetAttribute("requestID", "2");

			EmployeeQueryRq.AppendChild(inputXMLDoc.CreateElement("FullName")).InnerText = fullName;
			...
			return response;
			// parse the XML response and show a message
			//parseResponse(response, "TimeTrackingAddRs", "TimeTrackingRet");
		}*/
		...
		public ArrayList buildRequest() {
			...
			XmlElement EmployeeQueryRq = inputXMLDoc.CreateElement("EmployeeQueryRq");
			qbXMLMsgsRq.AppendChild(EmployeeQueryRq);
			EmployeeQueryRq.SetAttribute("requestID", "4");
			EmployeeQueryRq.AppendChild(inputXMLDoc.CreateElement("FullName")).InnerText = "ALAN NG";

			maxReturned = inputXMLDoc.CreateElement("MaxReturned");
			EmployeeQueryRq.AppendChild(maxReturned).InnerText = "1";
